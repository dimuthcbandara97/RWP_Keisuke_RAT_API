...
//	String good_catergorieString = "http://keisukebackend-env.eba-bnawaywp.us-east-1.elasticbeanstalk.com/admin/api/v1/good-categories";
...
//	String shopssString = "http://keisukebackend-env.eba-bnawaywp.us-east-1.elasticbeanstalk.com/admin/api/v1/shops";
//

	String good_catergorieString = "http://194.163.34.223:8082/swagger-ui/admin/api/v1/good-categories";
	String driverString = "http://194.163.34.223:8082/swagger-ui/admin/api/v1/drivers";
	String goodString = "http://194.163.34.223:8082/swagger-ui/admin/api/v1/goods";
	String managerString = "http://194.163.34.223:8082/swagger-ui/admin/api/v1/managers";
	String shopssString = "http://194.163.34.223:8082/swagger-ui/admin/api/v1/shops";
