...
public class TC_004_PUT_Request {
	...
	void registrationSuccessful_Driver()
	{
		...
		reqestParamsJsonObject.put("firstName", "Testing RAT_PUT");
		reqestParamsJsonObject.put("secondName", "Testing RAT_PUT");
		...
		reqestParamsJsonObject.put("addressLineOne", "ADD01_T_RAT_PUT");
		reqestParamsJsonObject.put("addressLineTwo", "ADD02_T_RAT_PUT");
		reqestParamsJsonObject.put("addressLineThree", "ADD03_T_RAT_PUT");
		...
		Response response = httpRequestSpecification.request(Method.PUT,"/modify/1");
	...
	void registrationSuccessful_Good_Categories()
	{
		...
		reqestParamsJsonObject.put("categoryName", "Testing RAT_PUT");
	...
	void registrationSuccessful_Manager()
	{
		...
		reqestParamsJsonObject.put("dialCode", 94);
		reqestParamsJsonObject.put("contactNumber", 037313);
		reqestParamsJsonObject.put("addressLineOne", "ADD01_T_RAT_2_PUT");
		reqestParamsJsonObject.put("addressLineTwo", "ADD02_T_RAT_2_PUT");
		reqestParamsJsonObject.put("addressLineThree", "ADD03_T_RAT_2_PUT");
	...
	void registrationSuccessful_Goods()
	{
		...
		reqestParamsJsonObject.put("itemName", "Testing RAT_PUT");
	...
	void registrationSuccessful_Shops()
	{
		...
		reqestParamsJsonObject.put("identityName", "Testing RAT_PUT");
		reqestParamsJsonObject.put("brNumber", "Testing RAT_PUT");
		reqestParamsJsonObject.put("dialCode", 94);
		reqestParamsJsonObject.put("contactNumber", 1222);
		reqestParamsJsonObject.put("addressLineOne", "ADD01_T_RAT_PUT");
		reqestParamsJsonObject.put("addressLineTwo", "ADD02_T_RAT_PUT");
		reqestParamsJsonObject.put("addressLineThree", "ADD03_T_RAT_PUT");
		reqestParamsJsonObject.put("longitude", "LON_RAT_PUT");
		reqestParamsJsonObject.put("latitude", "LAT_RAT_PUT");
